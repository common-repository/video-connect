...
class Dna88_CF7VideoMessageCreate
{
	...
	/**
	 * Create qcvideomsg_record record.
	 *
	...
	private function create_record( $cForm_id, $video_file_path ) {
		...
		$post_id 	= wp_insert_post( [
						...
						'post_title'    => esc_html('Recorded Video Link', 'dna88-wp-video'),
						'post_status'   => 'publish'
					] );
		...
		if ( $post_id ) {
			...
			$sample_rate = filter_input(INPUT_POST, 'dna88_vmwpmdp-wpvideomessage-video-sample-rate' );
